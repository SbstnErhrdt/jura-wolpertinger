...
describe('mobile hub navigation', () => {
  ...
  it('defines consistent mobile hover, active, focus and dark interaction states', async () => {
    ...
    expect(styles).toMatch(/\.mobile-nav a\[data-active\]\s*\{[^}]*background:\s*var\(--wolpi-nav-blue\)/s)
    expect(styles).toMatch(/\.mobile-nav a\.router-link-active\s*\{[^}]*background:/s)
    expect(styles).toMatch(/\.mobile-nav a\.router-link-active\s*\{[^}]*background:\s*var\(--wolpi-nav-blue\)/s)
    expect(styles).toContain(".mobile-nav a.router-link-active [data-slot='linkLabel']")
    expect(styles).toContain(".mobile-nav a.router-link-active [data-slot='leadingIcon']")
    expect(styles).toContain(".mobile-nav a[data-active] [data-slot='linkLabel']")
    expect(styles).toContain(".mobile-nav a[data-active] [data-slot='leadingIcon']")
    expect(styles).toMatch(/\.mobile-nav a\.router-link-active \[data-slot='leadingIcon'\][^{]*\{[^}]*color:\s*#fff/s)
    expect(styles).toMatch(/\.mobile-nav a\[data-active\] \[data-slot='leadingIcon'\][^{]*\{[^}]*color:\s*#fff/s)
