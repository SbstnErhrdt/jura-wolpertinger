...
Diese Guideline beschreibt die für Jura Wolpertinger `0.1.8` implementierten CI- und Release-Gates. Maßgeblich sind `.github/workflows/ci.yml`, `.github/workflows/release.yml` und die Scripts in `package.json`.
